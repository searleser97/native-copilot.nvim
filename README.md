...
Fleet membership, member names, or roles into session identity. Moves, reconnects, recovery, and
rollback persist and reuse `session.sessionId`. Older plugin-generated sessions remain available
through `/resume`.
